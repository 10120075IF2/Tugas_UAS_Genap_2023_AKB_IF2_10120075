...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText passwordKonfirmasiTextField;
    private Button signUpButton;
    private ImageView signInGoogleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passwordKonfirmasiTextField = findViewById(R.id.passwordKonfirmasiTextField);
    ...
    private void signUpWithEmail() {
        ...
        String passwordRetype = passwordKonfirmasiTextField.getText().toString().trim();

        if (email.isEmpty() || password.isEmpty() || passwordRetype.isEmpty()) {
            Toast.makeText(RegisterActivity.this, "Harap lengkapi semua data", Toast.LENGTH_SHORT).show();
            return;
        }
